...
def plot_nn_decision_surface(train_df, holdout_df, params, feature_mean, feature_std):
    ...
    # Show the full training cloud lightly, with hold-out samples emphasized.
    plt.scatter(X_train[y_train == 0, 0], X_train[y_train == 0, 1],
                s=12, alpha=0.22, label="Training class 0")
    plt.scatter(X_train[y_train == 1, 0], X_train[y_train == 1, 1],
                s=12, alpha=0.22, label="Training class 1")

    plt.scatter(X_hold[y_hold == 0, 0], X_hold[y_hold == 0, 1],
                s=30, marker="o", facecolors="none", label="Hold-out class 0")
    plt.scatter(X_hold[y_hold == 1, 0], X_hold[y_hold == 1, 1],
                s=30, marker="s", facecolors="none", label="Hold-out class 1")
